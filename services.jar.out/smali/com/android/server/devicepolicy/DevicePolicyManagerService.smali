...
.field private static final MONITORING_CERT_NOTIFICATION_ID:I = 0x1040109
...
.method public setDeviceOwner(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v3}, Lcom/android/server/devicepolicy/DeviceOwner;->isInstalled(Ljava/lang/String;Landroid/content/pm/PackageManager;)Z
    ...
    .line 3739
    .local v0, "avoidList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    const-string v3, "com.google.android.xts.deviceowner"

    invoke-virtual {v0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 3740
    const-string v3, "com.android.cts.deviceowner"
    ...
    const-string v6, "Trying to set device owner but device is already provisioned."
    ...
    .line 3774
    .end local v0    # "avoidList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :catchall_0
    move-exception v3
    ...
    .line 3745
    .restart local v0    # "avoidList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_3
    :try_start_1
    iget-object v3, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;

    if-eqz v3, :cond_4

    iget-object v3, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;

    invoke-virtual {v3}, Lcom/android/server/devicepolicy/DeviceOwner;->hasDeviceOwner()Z
    ...
    invoke-virtual {v3}, Lcom/android/server/devicepolicy/DeviceOwner;->getDeviceOwnerPackageName()Ljava/lang/String;

    move-result-object v3

    const-string v7, "com.android.cts.deviceowner"
    ...
    const-string v6, "Trying to set device owner but device owner is already set."
    ...
    invoke-interface {v2, v3, v7}, Landroid/app/backup/IBackupManager;->setBackupServiceActive(IZ)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    iput-object v3, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;

    .line 3766
    iget-object v3, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;

    invoke-virtual {v3}, Lcom/android/server/devicepolicy/DeviceOwner;->writeOwnerFile()V
    ...
    invoke-direct {v3, v6, v1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v3, p1, p2}, Lcom/android/server/devicepolicy/DeviceOwner;->setDeviceOwner(Ljava/lang/String;Ljava/lang/String;)V
