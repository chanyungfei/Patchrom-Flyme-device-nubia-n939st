...
.field private static final THREAD_ID_CONTENT_URI_ERROR:Landroid/net/Uri;
...
.method static constructor <clinit>()V
    ...
    .line 1912
    const-string v0, "content://mms-sms/threadID_error"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/Telephony$Threads;->THREAD_ID_CONTENT_URI_ERROR:Landroid/net/Uri;
...
.method public static getOrCreateThreadIdError(Landroid/content/Context;Ljava/util/Set;)J
    .locals 11
    .param p0, "context"    # Landroid/content/Context;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 2002
    sget-object v0, Landroid/provider/Telephony$Threads;->THREAD_ID_CONTENT_URI_ERROR:Landroid/net/Uri;
