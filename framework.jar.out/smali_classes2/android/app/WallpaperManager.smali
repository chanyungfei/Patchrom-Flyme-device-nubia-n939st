...
.method public getLockScreenWallpaper()Landroid/graphics/drawable/Drawable;
    ...
    # invokes: Landroid/app/WallpaperManager$Globals;->getLockScreenWallpaperLocked(Landroid/content/Context;)Landroid/graphics/Bitmap;
    invoke-static {v2, v3}, Landroid/app/WallpaperManager$Globals;->access$200(Landroid/app/WallpaperManager$Globals;Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method public isDefaultWallpaper()Z
    ...
    invoke-interface {v1}, Landroid/app/IWallpaperManager;->isDefaultWallpaperComponent()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setLockScreenWallpaper(Ljava/io/InputStream;)V
    .locals 11
    .param p1, "data"    # Ljava/io/InputStream;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    # getter for: Landroid/app/WallpaperManager$Globals;->mService:Landroid/app/IWallpaperManager;
    invoke-static {v8}, Landroid/app/WallpaperManager$Globals;->access$100(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;
    ...
    invoke-virtual {v4, v7, v8, v1}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v9, "**********setLockScreenWallpaper,RemoteException"
    ...
    const-string v10, "**********setLockScreenWallpaper, lockscreen.length = "
    ...
    .line 894
    .local v6, "temp_fos":Ljava/io/ByteArrayOutputStream;
    array-length v8, v3
    ...
    .end local v6    # "temp_fos":Ljava/io/ByteArrayOutputStream;
    invoke-direct {v6}, Ljava/io/ByteArrayOutputStream;-><init>()V

    .line 896
    .restart local v6    # "temp_fos":Ljava/io/ByteArrayOutputStream;
    const/4 v8, 0x0
    ...
    const-string v10, "**********setLockScreenWallpaper, new lockscreen.length = "
    ...
    invoke-interface {v8, v3}, Landroid/app/IWallpaperManager;->setLockScreenWallpaerHipad([B)V
