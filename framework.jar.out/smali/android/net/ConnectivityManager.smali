...
.method private expireRequest(Landroid/net/NetworkCapabilities;I)V
    ...
    .line 1255
    iget v3, v0, Landroid/net/ConnectivityManager$LegacyRequest;->expireSequenceNumber:I

    if-ne v3, p2, :cond_1

    .line 1256
    invoke-direct {p0, p1}, Landroid/net/ConnectivityManager;->removeRequestForFeature(Landroid/net/NetworkCapabilities;)Landroid/net/ConnectivityManager$NetworkCallback;

    move-result-object v1

    .line 1257
    .local v1, "ntcb":Landroid/net/ConnectivityManager$NetworkCallback;
    if-eqz v1, :cond_1

    .line 1258
    const-string v3, "ConnectivityManager"

    const-string/jumbo v5, "release request when timer expires"
    ...
    .line 1262
    .end local v1    # "ntcb":Landroid/net/ConnectivityManager$NetworkCallback;
    :cond_1
    monitor-exit v4
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v5, "expireRequest with "
