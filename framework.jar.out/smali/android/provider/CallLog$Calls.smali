...
.field public static final REJECT_TYPE:I = 0x9
...
.field private static currDate:J
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Landroid/provider/CallLog$Calls;->currDate:J
...
.method public static addCall(Lcom/android/internal/telephony/CallerInfo;Landroid/content/Context;Ljava/lang/String;IIILandroid/telecom/PhoneAccountHandle;JILjava/lang/Long;ZI)Landroid/net/Uri;
    ...
    sput-wide p7, Landroid/provider/CallLog$Calls;->currDate:J
...
.method private static addEntryAndRemoveExpiredEntries(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    sget-wide v8, Landroid/provider/CallLog$Calls;->currDate:J
    ...
    sget-wide v2, Landroid/provider/CallLog$Calls;->currDate:J
    ...
    const-string v1, "_id IN (SELECT _id FROM calls ORDER BY date DESC LIMIT -1 OFFSET 500)"

    invoke-virtual {v0, p1, v1, v5}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
