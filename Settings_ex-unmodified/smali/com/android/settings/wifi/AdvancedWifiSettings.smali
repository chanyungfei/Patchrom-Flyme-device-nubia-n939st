...
.method private initPreferences()V
    ...
    check-cast v19, Lcom/android/settings/AppListSwitchPreference;
    ...
    invoke-direct {v0, v10}, Lcom/android/settings/wifi/AdvancedWifiSettings;->initWifiAssistantPreference(Ljava/util/Collection;)V
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/AdvancedWifiSettings;->mAutoConnectionEnablePref:Landroid/preference/CheckBoxPreference;

    .line 300
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mAutoConnectionEnablePref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanPref:Landroid/preference/ListPreference;

    .line 311
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanPref:Landroid/preference/ListPreference;
    ...
    invoke-direct {v0, v1, v13}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateCellToWlanSummary(Landroid/preference/Preference;I)V
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanHintPref:Landroid/preference/CheckBoxPreference;

    .line 345
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanHintPref:Landroid/preference/CheckBoxPreference;
...
.method private refreshWifiInfo()V
    ...
    invoke-virtual {p0, v14}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getString(I)Ljava/lang/String;
...
.method private updateAutoConnectPref(Z)V
    ...
    .line 616
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mAutoConnectionEnablePref:Landroid/preference/CheckBoxPreference;
...
.method private updateCellularToWifiPrefs(Z)V
    ...
    .line 606
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateCellularToWlanHintPref(Z)V
    ...
    .line 610
    iget-object v1, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanPref:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateCellToWlanSummary(Landroid/preference/Preference;I)V
...
.method private updateCellularToWlanHintPref(Z)V
    ...
    .prologue
    .line 570
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanHintPref:Landroid/preference/CheckBoxPreference;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/settings/wifi/WpsDialog;-><init>(Landroid/content/Context;I)V
    ...
    .line 182
    .local v0, "wapiDialog":Lcom/android/settings/wifi/WapiCertMgmtDialog;
    invoke-virtual {v0, v2}, Lcom/android/settings/wifi/WapiCertMgmtDialog;->setMode(I)V
    ...
    .line 187
    .end local v0    # "wapiDialog":Lcom/android/settings/wifi/WapiCertMgmtDialog;
    :pswitch_3
    new-instance v0, Lcom/android/settings/wifi/WapiCertMgmtDialog;
    ...
    .line 188
    .restart local v0    # "wapiDialog":Lcom/android/settings/wifi/WapiCertMgmtDialog;
    invoke-virtual {v0, v3}, Lcom/android/settings/wifi/WapiCertMgmtDialog;->setMode(I)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 474
    invoke-direct {p0, p1, v7}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p0, v7}, Lcom/android/settings/wifi/AdvancedWifiSettings;->setCellToWlanType(I)V

    .line 543
    iget-object v10, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mCellularToWlanPref:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v10, v7}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateCellToWlanSummary(Landroid/preference/Preference;I)V
    ...
    :goto_1
    invoke-direct {p0, v10}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateAutoConnectPref(Z)V
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateCellularToWlanHintPref(Z)V
