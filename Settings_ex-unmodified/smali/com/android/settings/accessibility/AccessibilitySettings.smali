...
.method public constructor <init>()V
    ...
    .line 219
    iput-boolean v2, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootEnable:Z

    .line 221
    iput-boolean v2, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLedFlashLightEnable:Z
...
.method private getLEDStatus()Z
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/accessibility/AccessibilitySettings;->isFileExists(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/accessibility/AccessibilitySettings;->getLEDFlashBrightness(Ljava/lang/String;)Ljava/lang/String;
...
.method private handleToggleLEDflashlightPreferenceClick()V
    ...
    .prologue
    .line 323
    iget-object v2, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;
    ...
    const-class v3, Lcom/android/settings/accessibility/LedFlashlightReceiver;
...
.method private initializeAllPreferences()V
    ...
    iput-boolean v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLedFlashLightEnable:Z
    ...
    iput-object v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;

    .line 459
    iget-boolean v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLedFlashLightEnable:Z

    if-nez v6, :cond_0

    iget-object v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v7, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;
    ...
    iput-boolean v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootEnable:Z
    ...
    iput-object v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootPreference:Landroid/preference/SwitchPreference;

    .line 488
    iget-boolean v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootEnable:Z

    if-nez v6, :cond_1

    iget-object v6, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootPreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v7, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootPreference:Landroid/preference/SwitchPreference;
...
.method private updateSystemPreferences()V
    ...
    .line 642
    :try_start_0
    iget-object v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mCurConfig:Landroid/content/res/Configuration;
    ...
    .line 646
    :goto_0
    iget-object v8, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLargeTextPreference:Landroid/preference/SwitchPreference;
    ...
    .line 648
    iget-object v8, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleHighTextContrastPreference:Landroid/preference/SwitchPreference;
    ...
    .line 653
    iget-object v8, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleInversionPreference:Landroid/preference/SwitchPreference;
    ...
    .line 657
    iget-boolean v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLedFlashLightEnable:Z

    if-eqz v5, :cond_0

    .line 658
    invoke-direct {p0}, Lcom/android/settings/accessibility/AccessibilitySettings;->getLEDStatus()Z

    move-result v1

    .line 659
    .local v1, "isLightsOn":Z
    iget-object v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;
    ...
    :goto_4
    iget-object v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleSpeakPasswordPreference:Landroid/preference/SwitchPreference;

    invoke-virtual {v5, v3}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 684
    iget-boolean v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootEnable:Z

    if-eqz v5, :cond_1

    .line 685
    iget-object v8, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootPreference:Landroid/preference/SwitchPreference;
    ...
    iget v9, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLongPressTimeoutDefault:I
    ...
    invoke-direct {p0, v5, v8}, Lcom/android/settings/accessibility/AccessibilitySettings;->updateFeatureSummary(Ljava/lang/String;Landroid/preference/Preference;)V
    ...
    iget-object v8, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mDisplayDaltonizerPreferenceScreen:Landroid/preference/PreferenceScreen;
    ...
    .line 708
    iget-object v5, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mGlobalGesturePreferenceScreen:Landroid/preference/PreferenceScreen;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 289
    :cond_1
    iget-boolean v0, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mLedFlashLightEnable:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mToggleLEDflashlightPreference:Landroid/preference/SwitchPreference;

    if-ne v0, p2, :cond_2

    .line 291
    invoke-direct {p0}, Lcom/android/settings/accessibility/AccessibilitySettings;->handleToggleLEDflashlightPreferenceClick()V
    ...
    .line 306
    :cond_4
    iget-boolean v0, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootEnable:Z

    if-eqz v0, :cond_6

    iget-object v0, p0, Lcom/android/settings/accessibility/AccessibilitySettings;->mQuickBootPreference:Landroid/preference/SwitchPreference;
