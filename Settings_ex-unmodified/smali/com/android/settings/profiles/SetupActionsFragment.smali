...
.method private rebuildItemList()V
    ...
    .line 152
    iget-object v1, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mItems:Ljava/util/List;
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/Header;

    const v3, 0x7f09001f

    invoke-virtual {p0, v3}, Lcom/android/settings/profiles/SetupActionsFragment;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/android/settings/profiles/actions/item/Header;-><init>(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/ProfileNameItem;

    iget-object v3, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Landroid/app/Profile;

    invoke-direct {v2, v3}, Lcom/android/settings/profiles/actions/item/ProfileNameItem;-><init>(Landroid/app/Profile;)V
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;-><init>(ILandroid/app/ConnectionSettings;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/profiles/SetupActionsFragment;->generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/profiles/SetupActionsFragment;->generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/profiles/SetupActionsFragment;->generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-static {v1}, Lcom/android/settings/cyanogenmod/DeviceUtils;->deviceSupportsMobileData(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-direct {p0, v7}, Lcom/android/settings/profiles/SetupActionsFragment;->generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-static {v1}, Lcom/android/settings/cyanogenmod/DeviceUtils;->deviceSupportsNfc(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/profiles/SetupActionsFragment;->generateVolumeStreamItem(I)Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    ...
    invoke-direct {p0, v7}, Lcom/android/settings/profiles/SetupActionsFragment;->generateVolumeStreamItem(I)Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/profiles/SetupActionsFragment;->generateVolumeStreamItem(I)Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/RingModeItem;
    ...
    invoke-direct {v2, v3}, Lcom/android/settings/profiles/actions/item/RingModeItem;-><init>(Landroid/app/RingModeSettings;)V
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;
    ...
    invoke-direct {v2, v3}, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;-><init>(Landroid/app/AirplaneModeSettings;)V
    ...
    new-instance v2, Lcom/android/settings/profiles/actions/item/LockModeItem;

    iget-object v3, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Landroid/app/Profile;

    invoke-direct {v2, v3}, Lcom/android/settings/profiles/actions/item/LockModeItem;-><init>(Landroid/app/Profile;)V
...
.method private requestProfileName()V
    ...
    invoke-direct {v6, p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment$14;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/EditText;)V
    ...
    invoke-direct {v4, p0, v0}, Lcom/android/settings/profiles/SetupActionsFragment$15;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/app/AlertDialog;)V
...
.method public requestVolumeDialog(ILandroid/app/StreamSettings;)V
    ...
    invoke-direct {v7, p0, p2, v4}, Lcom/android/settings/profiles/SetupActionsFragment$10;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/app/StreamSettings;Landroid/widget/SeekBar;)V
    ...
    invoke-direct {v8, p0, v4, p2}, Lcom/android/settings/profiles/SetupActionsFragment$11;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/SeekBar;Landroid/app/StreamSettings;)V
    ...
    new-instance v8, Lcom/android/settings/profiles/SetupActionsFragment$12;

    invoke-direct {v8, p0}, Lcom/android/settings/profiles/SetupActionsFragment$12;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
    ...
    .line 704
    new-instance v7, Lcom/android/settings/profiles/SetupActionsFragment$13;

    invoke-direct {v7, p0, v6}, Lcom/android/settings/profiles/SetupActionsFragment$13;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/preference/SeekBarVolumizer;)V
