...
# interfaces
.implements Lcom/android/settings/fingerprint/AutoInterrpt$GetTHDCValueListener;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/settings/fingerprint/FingerPrintSettings;->doInterrupt(Z)V
.end annotation
...
# direct methods
.method constructor <init>(Lcom/android/settings/fingerprint/FingerPrintSettings;Z)V
    .locals 0
    ...
    iput-boolean p2, p0, Lcom/android/settings/fingerprint/FingerPrintSettings$5;->val$redo:Z
...
.method public OnFail()V
    ...
    invoke-static {v1}, Lcom/android/settings/fingerprint/FingerPrintSettings;->access$300(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/android/settings/fingerprint/FingerPrintSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    const-string v2, "interrrupt_key"

    invoke-static {v1, v2, v3}, Lcom/android/settings/fingerprint/FingerPrintUtils;->putIntDataByKey(Landroid/content/ContentResolver;Ljava/lang/String;I)V

    .line 529
    iget-object v1, p0, Lcom/android/settings/fingerprint/FingerPrintSettings$5;->this$0:Lcom/android/settings/fingerprint/FingerPrintSettings;

    # getter for: Lcom/android/settings/fingerprint/FingerPrintSettings;->mHandler:Landroid/os/Handler;
    invoke-static {v1}, Lcom/android/settings/fingerprint/FingerPrintSettings;->access$700(Lcom/android/settings/fingerprint/FingerPrintSettings;)Landroid/os/Handler;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/settings/fingerprint/FingerPrintSettings$5;->val$redo:Z
