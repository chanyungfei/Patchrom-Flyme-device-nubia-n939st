...
.method private rebuildUI(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/settings/dashboard/DashboardTile;->getTitle(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    .line 183
    new-instance v23, Lcom/android/settings/dashboard/DashboardTileView;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/settings/dashboard/DashboardTileView;-><init>(Landroid/content/Context;Z)V

    .line 184
    .local v23, "tileView":Lcom/android/settings/dashboard/DashboardTileView;
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/settings/dashboard/DashboardSummary;->mLte4GEnabler:Lcom/android/settings/Lte4GEnabler;

    invoke-virtual/range {v23 .. v23}, Lcom/android/settings/dashboard/DashboardTileView;->getSwitch()Landroid/widget/Switch;
    ...
    invoke-virtual {v0, v15}, Lcom/android/settings/dashboard/DashboardTileView;->setEnabled(Z)V

    .line 191
    invoke-virtual/range {v23 .. v23}, Lcom/android/settings/dashboard/DashboardTileView;->getTitleTextView()Landroid/widget/TextView;
    ...
    iput v2, v5, Lcom/android/settings/dashboard/DashboardTile;->iconRes:I

    .line 199
    :goto_4
    invoke-virtual/range {v23 .. v23}, Lcom/android/settings/dashboard/DashboardTileView;->getImageView()Landroid/widget/ImageView;
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/settings/dashboard/DashboardSummary;->updateTileView(Landroid/content/Context;Landroid/content/res/Resources;Lcom/android/settings/dashboard/DashboardTile;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/Switch;)V
    ...
    .end local v15    # "enabled":Z
    .end local v20    # "simState":I
    .end local v23    # "tileView":Lcom/android/settings/dashboard/DashboardTileView;
    :cond_3
    invoke-virtual {v5, v4}, Lcom/android/settings/dashboard/DashboardTile;->getTitle(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    .line 204
    .restart local v23    # "tileView":Lcom/android/settings/dashboard/DashboardTileView;
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/settings/dashboard/DashboardSummary;->mDataEnabler:Lcom/android/settings/DataEnabler;

    invoke-virtual/range {v23 .. v23}, Lcom/android/settings/dashboard/DashboardTileView;->getSwitch()Landroid/widget/Switch;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/android/settings/DataEnabler;->setSwitch(Landroid/widget/Switch;)V
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/settings/dashboard/DashboardTileView;->getStatusTextView()Landroid/widget/TextView;
...
.method private updateTileView(Landroid/content/Context;Landroid/content/res/Resources;Lcom/android/settings/dashboard/DashboardTile;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/Switch;)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 268
    iget v0, p3, Lcom/android/settings/dashboard/DashboardTile;->iconRes:I
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v1, p0, Lcom/android/settings/dashboard/DashboardSummary;->mLte4GEnabler:Lcom/android/settings/Lte4GEnabler;

    .line 142
    new-instance v1, Lcom/android/settings/DataEnabler;
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/settings/DataEnabler;-><init>(Landroid/content/Context;Landroid/widget/Switch;)V

    iput-object v1, p0, Lcom/android/settings/dashboard/DashboardSummary;->mDataEnabler:Lcom/android/settings/DataEnabler;
...
.method public onDestroy()V
    ...
    .line 132
    iget-object v0, p0, Lcom/android/settings/dashboard/DashboardSummary;->mDataEnabler:Lcom/android/settings/DataEnabler;

    invoke-virtual {v0}, Lcom/android/settings/DataEnabler;->destroy()V
...
.method public onPause()V
    ...
    .line 120
    iget-object v0, p0, Lcom/android/settings/dashboard/DashboardSummary;->mLte4GEnabler:Lcom/android/settings/Lte4GEnabler;

    invoke-virtual {v0}, Lcom/android/settings/Lte4GEnabler;->pause()V
    ...
    iget-object v1, p0, Lcom/android/settings/dashboard/DashboardSummary;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public onResume()V
    ...
    .line 97
    iget-object v2, p0, Lcom/android/settings/dashboard/DashboardSummary;->mLte4GEnabler:Lcom/android/settings/Lte4GEnabler;

    invoke-virtual {v2}, Lcom/android/settings/Lte4GEnabler;->resume()V

    .line 99
    iget-object v2, p0, Lcom/android/settings/dashboard/DashboardSummary;->mDataEnabler:Lcom/android/settings/DataEnabler;

    invoke-virtual {v2}, Lcom/android/settings/DataEnabler;->resume()V
    ...
    iget-object v3, p0, Lcom/android/settings/dashboard/DashboardSummary;->mReceiver:Landroid/content/BroadcastReceiver;
