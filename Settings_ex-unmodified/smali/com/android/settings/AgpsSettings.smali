...
.method private checkNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 225
    sget-object p1, Lcom/android/settings/AgpsSettings;->sNotSet:Ljava/lang/String;
...
.method private fillUi(Z)V
    ...
    .line 205
    iget-object v0, p0, Lcom/android/settings/AgpsSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->getSuplServer()Ljava/lang/String;
    ...
    .line 206
    iget-object v0, p0, Lcom/android/settings/AgpsSettings;->mPort:Landroid/preference/EditTextPreference;

    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->getSuplPort()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/AgpsSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-virtual {v1}, Landroid/preference/EditTextPreference;->getText()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/android/settings/AgpsSettings;->checkNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/AgpsSettings;->mPort:Landroid/preference/EditTextPreference;
    ...
    .line 211
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->setPrefAgpsType()V

    .line 212
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->setPrefAgpsNetwork()V

    .line 213
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->setPrefAgpsResetType()V
...
.method private restoreAgpsParam()V
    ...
    iput-object v8, p0, Lcom/android/settings/AgpsSettings;->mAssistedType:Ljava/lang/String;

    .line 349
    const-string v8, "HOME"

    iput-object v8, p0, Lcom/android/settings/AgpsSettings;->mNetworkType:Ljava/lang/String;

    .line 350
    const-string v8, "HOT"

    iput-object v8, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;

    .line 351
    const-string v8, "providerid"

    iget-object v9, p0, Lcom/android/settings/AgpsSettings;->mAssistedType:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/settings/AgpsSettings;->mNetworkType:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;

    invoke-virtual {v1, v8, v9}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 354
    invoke-direct {p0, v1}, Lcom/android/settings/AgpsSettings;->SetValue(Landroid/os/Bundle;)V

    .line 355
    const/4 v8, 0x1

    invoke-direct {p0, v8}, Lcom/android/settings/AgpsSettings;->fillUi(Z)V

    .line 356
    const-string v8, "location"

    invoke-virtual {p0, v8}, Lcom/android/settings/AgpsSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v8, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;
...
.method private saveAgpsParams()V
    ...
    iget-object v2, p0, Lcom/android/settings/AgpsSettings;->mServer:Landroid/preference/EditTextPreference;

    invoke-virtual {v2}, Landroid/preference/EditTextPreference;->getText()Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/android/settings/AgpsSettings;->checkNotSet(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/AgpsSettings;->mPort:Landroid/preference/EditTextPreference;
    ...
    iget-object v2, p0, Lcom/android/settings/AgpsSettings;->mAssistedType:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/AgpsSettings;->mNetworkType:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 316
    iget-object v1, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;
    ...
    .line 324
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/settings/AgpsSettings;->SetValue(Landroid/os/Bundle;)V
...
.method private setPrefAgpsNetwork()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/AgpsSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->getPrefNetwork()Ljava/lang/String;

    move-result-object v0

    .line 174
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/AgpsSettings;->mNetworkType:Ljava/lang/String;
...
.method private setPrefAgpsResetType()V
    ...
    .line 188
    .local v2, "types":[Ljava/lang/String;
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->getPrefAgpsResetType()Ljava/lang/String;

    move-result-object v0

    .line 189
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;
...
.method private setPrefAgpsType()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/AgpsSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->getPrefAgpsType()Ljava/lang/String;

    move-result-object v0

    .line 156
    .local v0, "defPref":Ljava/lang/String;
    iput-object v0, p0, Lcom/android/settings/AgpsSettings;->mAssistedType:Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sput-object v0, Lcom/android/settings/AgpsSettings;->sNotSet:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/AgpsSettings;->mServer:Landroid/preference/EditTextPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/AgpsSettings;->mPort:Landroid/preference/EditTextPreference;

    .line 132
    invoke-direct {p0, v1}, Lcom/android/settings/AgpsSettings;->fillUi(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 299
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->saveAgpsParams()V

    goto :goto_0

    .line 303
    :pswitch_1
    invoke-direct {p0}, Lcom/android/settings/AgpsSettings;->restoreAgpsParam()V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iput-object v5, p0, Lcom/android/settings/AgpsSettings;->mNetworkType:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/settings/AgpsSettings;->mResetType:Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/android/settings/AgpsSettings;->mAssistedType:Ljava/lang/String;
