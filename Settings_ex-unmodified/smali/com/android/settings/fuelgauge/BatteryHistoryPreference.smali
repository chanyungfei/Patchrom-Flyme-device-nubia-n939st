...
.method public constructor <init>(Landroid/content/Context;Landroid/os/BatteryStats;Landroid/content/Intent;)V
    ...
    .line 55
    iput-object p1, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mContext:Landroid/content/Context;
...
.method static synthetic access$000(Lcom/android/settings/fuelgauge/BatteryHistoryPreference;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/BatteryHistoryPreference;

    .prologue
    .line 40
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mContext:Landroid/content/Context;
...
.method protected onBindView(Landroid/view/View;)V
    ...
    iget-object v5, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mBatteryBroadcast:Landroid/content/Intent;

    invoke-virtual {v0, v3, v5}, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->setStats(Landroid/os/BatteryStats;Landroid/content/Intent;)V
    ...
    .line 97
    iget-object v5, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mLabelHeader:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->statusbar_show_battery_percent:Landroid/widget/CheckBox;

    .line 101
    iget-object v3, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->statusbar_show_battery_percent:Landroid/widget/CheckBox;

    new-instance v5, Lcom/android/settings/fuelgauge/BatteryHistoryPreference$1;

    invoke-direct {v5, p0}, Lcom/android/settings/fuelgauge/BatteryHistoryPreference$1;-><init>(Lcom/android/settings/fuelgauge/BatteryHistoryPreference;)V
    ...
    .line 107
    iget-object v3, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mContext:Landroid/content/Context;
    ...
    iget-object v5, p0, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;->mChart:Lcom/android/settings/fuelgauge/BatteryHistoryChart;
