...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    invoke-static/range {v35 .. v36}, Lcom/android/settings/SecuritySettings;->getResIdForLockUnlockScreen(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I
    ...
    .line 295
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/SecuritySettings;->getshortcutName()Ljava/lang/String;
    ...
    invoke-static/range {v35 .. v36}, Lcom/android/settings/SecuritySettings;->getActiveTrustAgents(Landroid/content/pm/PackageManager;Lcom/android/internal/widget/LockPatternUtils;)Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mDMAutoBoot:Landroid/preference/SwitchPreference;

    .line 455
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/SecuritySettings;->mDMAutoBoot:Landroid/preference/SwitchPreference;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/SecuritySettings;->isDMAutoboot()Z
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mBlacklist:Landroid/preference/PreferenceScreen;
    ...
    iget-object v0, v0, Lcom/android/settings/SecuritySettings;->mBlacklist:Landroid/preference/PreferenceScreen;
    ...
    invoke-static/range {v35 .. v35}, Lcom/android/settings/search/Index;->getInstance(Landroid/content/Context;)Lcom/android/settings/search/Index;

    move-result-object v35

    const-class v36, Lcom/android/settings/SecuritySettings;
    ...
    invoke-virtual/range {v35 .. v38}, Lcom/android/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V

    .line 522
    const/4 v15, 0x0

    :goto_b
    sget-object v35, Lcom/android/settings/SecuritySettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;
...
.method private updateBlacklistSummary()V
    ...
    .prologue
    .line 1046
    iget-object v0, p0, Lcom/android/settings/SecuritySettings;->mBlacklist:Landroid/preference/PreferenceScreen;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v7, p0}, Lcom/android/settings/ChooseLockSettingsHelper;-><init>(Landroid/app/Activity;Landroid/app/Fragment;)V

    .line 853
    .local v1, "helper":Lcom/android/settings/ChooseLockSettingsHelper;
    const/16 v7, 0x7d

    invoke-virtual {v1, v7, v10, v10}, Lcom/android/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    .line 860
    iget-object v7, p0, Lcom/android/settings/SecuritySettings;->mBiometricWeakLiveliness:Landroid/preference/SwitchPreference;
    ...
    .line 870
    iget-object v7, p0, Lcom/android/settings/SecuritySettings;->mToggleAppInstallation:Landroid/preference/SwitchPreference;
    ...
    .line 875
    :cond_9
    invoke-direct {p0, v8}, Lcom/android/settings/SecuritySettings;->setNonMarketAppsAllowed(Z)V
    ...
    .line 881
    invoke-direct {p0, v5}, Lcom/android/settings/SecuritySettings;->updateSmsSecuritySummary(I)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 789
    iget-object v0, p0, Lcom/android/settings/SecuritySettings;->mDMAutoBoot:Landroid/preference/SwitchPreference;

    invoke-virtual {v0}, Landroid/preference/SwitchPreference;->isChecked()Z

    move-result v0

    invoke-direct {p0, v0}, Lcom/android/settings/SecuritySettings;->setDMAutoboot(Z)V
...
.method public onResume()V
    ...
    .line 758
    :cond_4
    invoke-direct {p0}, Lcom/android/settings/SecuritySettings;->updateBlacklistSummary()V
