...
.method static synthetic access$2100(Lcom/android/settings_ex/sim/SimSettings$SimPreference;)Landroid/telephony/SubscriptionInfo;
    .locals 1
...
.method public createEditDialog(Lcom/android/settings_ex/sim/SimSettings$SimPreference;)V
    ...
    iget-object v13, v0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->this$0:Lcom/android/settings_ex/sim/SimSettings;

    invoke-virtual {v13}, Lcom/android/settings_ex/sim/SimSettings;->getActivity()Landroid/app/Activity;
    ...
    iget-object v13, v0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSubscriptionInfo:Landroid/telephony/SubscriptionInfo;
    ...
    iget-object v14, v0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSubscriptionInfo:Landroid/telephony/SubscriptionInfo;

    # invokes: Lcom/android/settings_ex/sim/SimSettings;->getPhoneNumber(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    invoke-static {v13, v14}, Lcom/android/settings_ex/sim/SimSettings;->access$2000(Lcom/android/settings_ex/sim/SimSettings;Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    ...
    invoke-virtual {v13}, Lcom/android/settings_ex/sim/SimSettings;->getResources()Landroid/content/res/Resources;
    ...
    .line 971
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->getContext()Landroid/content/Context;
    ...
    .line 975
    new-instance v13, Lcom/android/settings_ex/sim/SimSettings$SimPreference$1;

    move-object/from16 v0, p0

    invoke-direct {v13, v0, v5}, Lcom/android/settings_ex/sim/SimSettings$SimPreference$1;-><init>(Lcom/android/settings_ex/sim/SimSettings$SimPreference;Landroid/content/SharedPreferences$Editor;)V
    ...
    iget v0, v0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSlotId:I
    ...
    new-instance v14, Lcom/android/settings_ex/sim/SimSettings$SimPreference$2;

    move-object/from16 v0, p0

    invoke-direct {v14, v0, v3, v5}, Lcom/android/settings_ex/sim/SimSettings$SimPreference$2;-><init>(Lcom/android/settings_ex/sim/SimSettings$SimPreference;Landroid/view/View;Landroid/content/SharedPreferences$Editor;)V
    ...
    new-instance v14, Lcom/android/settings_ex/sim/SimSettings$SimPreference$3;

    move-object/from16 v0, p0

    invoke-direct {v14, v0}, Lcom/android/settings_ex/sim/SimSettings$SimPreference$3;-><init>(Lcom/android/settings_ex/sim/SimSettings$SimPreference;)V
    ...
    # setter for: Lcom/android/settings_ex/sim/SimSettings;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v13, v14}, Lcom/android/settings_ex/sim/SimSettings;->access$2202(Lcom/android/settings_ex/sim/SimSettings;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    # getter for: Lcom/android/settings_ex/sim/SimSettings;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v13}, Lcom/android/settings_ex/sim/SimSettings;->access$2200(Lcom/android/settings_ex/sim/SimSettings;)Landroid/app/AlertDialog;
...
.method protected onAttachedToActivity()V
    ...
    invoke-static {v0}, Lcom/android/settings_ex/sim/SimSettings;->access$1900(Lcom/android/settings_ex/sim/SimSettings;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/settings_ex/sim/SimSettings;->access$1902(Lcom/android/settings_ex/sim/SimSettings;Z)Z
...
.method public update()V
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/sim/SimSettings;->getActivity()Landroid/app/Activity;

    move-result-object v2

    iget v3, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSlotId:I

    invoke-static {v2, v3}, Lcom/android/settings_ex/Utils;->findRecordBySlotId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;

    move-result-object v2

    iput-object v2, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSubscriptionInfo:Landroid/telephony/SubscriptionInfo;

    .line 907
    iget-object v2, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->this$0:Lcom/android/settings_ex/sim/SimSettings;

    invoke-virtual {v2}, Lcom/android/settings_ex/sim/SimSettings;->getResources()Landroid/content/res/Resources;
    ...
    iget v4, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSlotId:I
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 910
    iget-object v2, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSubscriptionInfo:Landroid/telephony/SubscriptionInfo;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->mSubscriptionInfo:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings_ex/sim/SimSettings;->getOperatorName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 925
    :goto_0
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setEnabled(Z)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings_ex/sim/SimSettings;->getOperatorName2(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setSummary(I)V

    .line 928
    const/4 v2, 0x0

    invoke-virtual {p0, v2}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setFragment(Ljava/lang/String;)V
