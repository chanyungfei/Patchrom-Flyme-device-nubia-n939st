...
.method static constructor <clinit>()V
    ...
    .line 111
    sput-object v0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mPreDeviceAddress:Ljava/lang/String;

    .line 112
    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mNeedToRemove:Z
...
.method static synthetic access$100(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothSettings;

    .prologue
    .line 84
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothSettings;

    .prologue
    .line 84
    invoke-direct {p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->promptBtTip()V

    return-void
.end method

.method static synthetic access$300(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)Landroid/widget/CheckBox;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothSettings;

    .prologue
    .line 84
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myCheckBox:Landroid/widget/CheckBox;

    return-object v0
.end method

.method static synthetic access$400(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothSettings;

    .prologue
    .line 84
    invoke-direct {p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->setNeverNotifyFlag()Z
...
.method static synthetic access$500(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothSettings;

    .prologue
    .line 84
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myHandler:Landroid/os/Handler;
...
.method static synthetic access$600()Ljava/lang/String;
    ...
    .prologue
    .line 84
    sget-object v0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mPreDeviceAddress:Ljava/lang/String;
...
.method static synthetic access$602(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 84
    sput-object p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mPreDeviceAddress:Ljava/lang/String;
...
.method static synthetic access$700()Z
    ...
    .prologue
    .line 84
    sget-boolean v0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mNeedToRemove:Z
...
.method static synthetic access$702(Z)Z
    ...
    .prologue
    .line 84
    sput-boolean p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mNeedToRemove:Z
...
.method private beginBtPrompt()V
    ...
    new-instance v1, Lcom/android/settings_ex/bluetooth/BluetoothSettings$3;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings$3;-><init>(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)V
...
.method private neverNotify()Z
    ...
    .prologue
    .line 222
    iget-object v2, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;
...
.method private promptBtTip()V
    ...
    iget-object v2, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myFrmLayout:Landroid/widget/FrameLayout;
    ...
    new-instance v3, Lcom/android/settings_ex/bluetooth/BluetoothSettings$5;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings$5;-><init>(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)V
...
.method private setNeverNotifyFlag()Z
    ...
    .line 209
    .local v0, "btTip":Ljava/lang/String;
    iget-object v4, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;
...
.method private updateContent(I)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->setDeviceListGroup(Landroid/preference/PreferenceGroup;)V
    ...
    .line 414
    :pswitch_0
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;
    ...
    .line 420
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mDevicePreferenceMap:Ljava/util/WeakHashMap;
    ...
    .line 428
    :cond_2
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mPairedDevicesCategory:Landroid/preference/PreferenceGroup;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mPairedDevicesCategory:Landroid/preference/PreferenceGroup;
    ...
    invoke-direct {p0, v6, v7, v8, v11}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->addDeviceCategory(Landroid/preference/PreferenceGroup;ILcom/android/settings_ex/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    ...
    .line 444
    new-instance v6, Lcom/android/settings_ex/bluetooth/BluetoothProgressCategory;

    invoke-virtual {p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->getActivity()Landroid/app/Activity;

    move-result-object v7

    invoke-direct {v6, v7}, Lcom/android/settings_ex/bluetooth/BluetoothProgressCategory;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mAvailableDevicesCategory:Landroid/preference/PreferenceGroup;
    ...
    invoke-direct {p0, v6, v7, v8, v9}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->addDeviceCategory(Landroid/preference/PreferenceGroup;ILcom/android/settings_ex/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    ...
    .line 458
    :cond_5
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mMyDevicePreference:Landroid/preference/Preference;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mMyDevicePreference:Landroid/preference/Preference;
    ...
    .line 473
    iget-boolean v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mInitiateDiscoverable:Z

    if-eqz v6, :cond_1

    .line 475
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mLocalAdapter:Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;

    const/16 v7, 0x17

    invoke-virtual {v6, v7}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->setScanMode(I)V
    ...
    .line 486
    :pswitch_2
    iget-boolean v6, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mAvailableDevicesCategoryIsPresent:Z
    ...
    check-cast v6, Lcom/android/settings_ex/bluetooth/BluetoothProgressCategory;

    invoke-virtual {v6, v10}, Lcom/android/settings_ex/bluetooth/BluetoothProgressCategory;->setProgress(Z)V
    ...
    .line 497
    iput-boolean v10, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mInitialScanStarted:Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 173
    iput-object v0, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;

    .line 174
    iget-object v1, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myFrmLayout:Landroid/widget/FrameLayout;

    .line 175
    iget-object v1, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myFrmLayout:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myCheckBox:Landroid/widget/CheckBox;

    .line 176
    new-instance v1, Lcom/android/settings_ex/bluetooth/BluetoothSettings$2;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings$2;-><init>(Lcom/android/settings_ex/bluetooth/BluetoothSettings;)V

    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->myHandler:Landroid/os/Handler;

    .line 196
    invoke-direct {p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->neverNotify()Z
    ...
    .line 197
    invoke-direct {p0}, Lcom/android/settings_ex/bluetooth/BluetoothSettings;->beginBtPrompt()V
...
.method public onResume()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->setBluetoothStateInt(I)V
