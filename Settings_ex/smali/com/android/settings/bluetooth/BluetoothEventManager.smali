...
.method constructor <init>(Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;Lcom/android/settings_ex/bluetooth/CachedBluetoothDeviceManager;Landroid/content/Context;)V
    ...
    .param p2, "deviceManager"    # Lcom/android/settings_ex/bluetooth/CachedBluetoothDeviceManager;
    ...
    .line 111
    invoke-direct {p0}, Lcom/android/settings_ex/bluetooth/BluetoothEventManager;->setDefaultBtName()V
...
.method static synthetic access$1000(Lcom/android/settings_ex/bluetooth/BluetoothEventManager;)Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothEventManager;
...
.method static synthetic access$1100(Lcom/android/settings_ex/bluetooth/BluetoothEventManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothEventManager;
...
.method static synthetic access$1500(Lcom/android/settings_ex/bluetooth/BluetoothEventManager;Lcom/android/settings_ex/bluetooth/CachedBluetoothDevice;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/bluetooth/BluetoothEventManager;
    .param p1, "x1"    # Lcom/android/settings_ex/bluetooth/CachedBluetoothDevice;
...
.method private setDefaultBtName()V
    ...
    .line 120
    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/BluetoothEventManager;->mContext:Landroid/content/Context;
    ...
    const-string v10, "custome bluetooth name: "
    ...
    .line 127
    .local v3, "notSet":Z
    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/BluetoothEventManager;->mLocalAdapter:Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v8}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->getBluetoothState()I
    ...
    invoke-virtual {v6, v1}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->setName(Ljava/lang/String;)V
    ...
    .end local v2    # "needSet":Z
    .end local v3    # "notSet":Z
    .end local v4    # "okToSet":Z
    ...
    .restart local v2    # "needSet":Z
    .restart local v3    # "notSet":Z
...
.method addHandler(Ljava/lang/String;Lcom/android/settings_ex/bluetooth/BluetoothEventManager$Handler;)V
    ...
    .param p2, "handler"    # Lcom/android/settings_ex/bluetooth/BluetoothEventManager$Handler;
...
.method registerCallback(Lcom/android/settings_ex/bluetooth/BluetoothCallback;)V
    .locals 2
    .param p1, "callback"    # Lcom/android/settings_ex/bluetooth/BluetoothCallback;
...
.method setProfileManager(Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;)V
    .locals 0
    .param p1, "manager"    # Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;
