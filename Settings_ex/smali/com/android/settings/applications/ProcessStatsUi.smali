...
# interfaces
.implements Lcom/android/settings_ex/applications/LinearColorBar$OnRegionTappedListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sEntryCompare:Ljava/util/Comparator;

    .line 132
    sget-wide v0, Lcom/android/internal/app/ProcessStats;->COMMIT_PERIOD:J

    sput-wide v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->DURATION_QUANTUM:J
    ...
    sget-wide v4, Lcom/android/settings_ex/applications/ProcessStatsUi;->DURATION_QUANTUM:J
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurations:[J
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurationLabels:[I
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->RED_MEM_STATES:[I
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->YELLOW_MEM_STATES:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDurationMenus:[Landroid/view/MenuItem;

    .line 118
    new-array v0, v1, [J

    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTimes:[J
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStateWeights:[D
...
.method private load()V
    ...
    .line 788
    :try_start_0
    iget-wide v4, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J

    iput-wide v4, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mLastDuration:J

    .line 789
    iget-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mProcessStats:Lcom/android/internal/app/IProcessStats;

    invoke-interface {v3}, Lcom/android/internal/app/IProcessStats;->getCurrentMemoryState()I

    move-result v3

    iput v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemState:I
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
...
.method private refreshStats()V
    ...
    .prologue
    .line 384
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->updateMenus()V

    .line 386
    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;

    if-eqz v8, :cond_0

    move-object/from16 v0, p0

    iget-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mLastDuration:J

    move-object/from16 v0, p0

    iget-wide v0, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J
    ...
    .line 387
    :cond_0
    invoke-direct/range {p0 .. p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->load()V

    .line 392
    :cond_1
    move-object/from16 v0, p0

    iget v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
    ...
    .line 393
    sget-object v76, Lcom/android/settings_ex/applications/ProcessStatsUi;->FOREGROUND_PROC_STATES:[I

    .line 394
    .local v76, "stats":[I
    const v77, 0x7f0907da
    ...
    iget-object v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mAppListGroup:Landroid/preference/PreferenceGroup;
    ...
    iget-object v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStatusPref:Landroid/preference/Preference;
    ...
    iget-object v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStatusPref:Landroid/preference/Preference;

    invoke-virtual {v8, v10}, Landroid/preference/PreferenceGroup;->addPreference(Landroid/preference/Preference;)Z

    .line 411
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v8, v10, v11, v14}, Lcom/android/settings_ex/Utils;->formatElapsedTime(Landroid/content/Context;DZ)Ljava/lang/String;

    move-result-object v28

    .line 413
    .local v28, "durationString":Ljava/lang/String;
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->getResources()Landroid/content/res/Resources;
    ...
    iget v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemState:I
    ...
    iget-object v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTotalTime:J
    ...
    iget-object v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTimes:[J
    ...
    .line 396
    sget-object v76, Lcom/android/settings_ex/applications/ProcessStatsUi;->CACHED_PROC_STATES:[I

    .line 397
    .restart local v76    # "stats":[I
    const v77, 0x7f0907db
    ...
    iget-boolean v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z

    if-eqz v8, :cond_4

    sget-object v76, Lcom/android/settings_ex/applications/ProcessStatsUi;->BACKGROUND_AND_SYSTEM_PROC_STATES:[I

    .line 401
    .restart local v76    # "stats":[I
    :goto_3
    const v77, 0x7f0907d9
    ...
    iget-object v14, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    :cond_8
    new-instance v27, Lcom/android/settings_ex/applications/LinearColorPreference;
    ...
    invoke-direct {v0, v8}, Lcom/android/settings_ex/applications/LinearColorPreference;-><init>(Landroid/content/Context;)V

    .line 456
    .local v27, "colors":Lcom/android/settings_ex/applications/LinearColorPreference;
    const/4 v8, -0x1

    move-object/from16 v0, v27

    invoke-virtual {v0, v8}, Lcom/android/settings_ex/applications/LinearColorPreference;->setOrder(I)V

    .line 457
    move-object/from16 v0, p0

    iget v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemRegion:I
    ...
    iget-wide v0, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTotalTime:J
    ...
    invoke-virtual {v0, v8}, Lcom/android/settings_ex/applications/LinearColorPreference;->setColoredRegions(I)V

    .line 476
    sget-object v23, Lcom/android/settings_ex/Utils;->BADNESS_COLORS:[I
    ...
    iget-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTotalTime:J
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/settings_ex/applications/LinearColorPreference;->setColors(III)V
    ...
    iget-object v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTimes:[J
    ...
    sget-object v52, Lcom/android/settings_ex/applications/ProcessStatsUi;->RED_MEM_STATES:[I
    ...
    .line 466
    .restart local v56    # "memTotalTime":J
    sget-object v52, Lcom/android/settings_ex/applications/ProcessStatsUi;->YELLOW_MEM_STATES:[I
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemCachedWeight:D
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemFreeWeight:D
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemZRamWeight:D
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemKernelWeight:D
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemNativeWeight:D
    ...
    iget-object v8, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStateWeights:[D
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTotalWeight:D
    ...
    invoke-virtual {v0, v1, v8, v10}, Lcom/android/settings_ex/applications/LinearColorPreference;->setRatios(FFF)V
    ...
    .line 624
    .local v32, "entries":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    ...
    .line 625
    .local v33, "entriesMap":Lcom/android/internal/app/ProcessMap;, "Lcom/android/internal/app/ProcessMap<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    const/16 v41, 0x0
    ...
    .end local v21    # "N":I
    .end local v32    # "entries":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    .end local v33    # "entriesMap":Lcom/android/internal/app/ProcessMap;, "Lcom/android/internal/app/ProcessMap<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    ...
    .restart local v32    # "entries":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    .restart local v33    # "entriesMap":Lcom/android/internal/app/ProcessMap;, "Lcom/android/internal/app/ProcessMap<Lcom/android/settings_ex/applications/ProcStatsEntry;>;"
    ...
    .line 642
    .local v6, "ent":Lcom/android/settings_ex/applications/ProcStatsEntry;
    if-nez v6, :cond_13

    .line 643
    new-instance v6, Lcom/android/settings_ex/applications/ProcStatsEntry;

    .end local v6    # "ent":Lcom/android/settings_ex/applications/ProcStatsEntry;
    move-object/from16 v0, v74
    ...
    iget-boolean v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z

    move-object/from16 v0, p0

    iget v11, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
    ...
    :goto_11
    invoke-direct/range {v6 .. v11}, Lcom/android/settings_ex/applications/ProcStatsEntry;-><init>(Lcom/android/internal/app/ProcessStats$ProcessState;Ljava/lang/String;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;ZZ)V

    .line 645
    .restart local v6    # "ent":Lcom/android/settings_ex/applications/ProcStatsEntry;
    iget-wide v10, v6, Lcom/android/settings_ex/applications/ProcStatsEntry;->mDuration:J
    ...
    invoke-virtual {v6, v8}, Lcom/android/settings_ex/applications/ProcStatsEntry;->addPackage(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v0}, Lcom/android/settings_ex/applications/ProcStatsEntry;->addService(Lcom/android/internal/app/ProcessStats$ServiceState;)V
    ...
    :cond_1d
    sget-object v8, Lcom/android/settings_ex/applications/ProcessStatsUi;->sEntryCompare:Ljava/util/Comparator;
    ...
    .line 722
    .local v7, "proc":Lcom/android/settings_ex/applications/ProcStatsEntry;
    iget-wide v10, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mWeight:J
    ...
    .line 723
    iget-wide v0, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mWeight:J
    ...
    .end local v7    # "proc":Lcom/android/settings_ex/applications/ProcStatsEntry;
    :cond_1f
    const/16 v21, 0x0
    ...
    iput-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMaxWeight:J

    .line 728
    move-object/from16 v0, p0

    iget-wide v10, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMaxWeight:J
    ...
    iput-wide v0, v2, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMaxWeight:J
    ...
    .line 746
    .restart local v7    # "proc":Lcom/android/settings_ex/applications/ProcStatsEntry;
    iget-wide v10, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mWeight:J
    ...
    iget-wide v0, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMaxWeight:J
    ...
    iget-wide v10, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mDuration:J
    ...
    new-instance v65, Lcom/android/settings_ex/applications/ProcessStatsPreference;
    ...
    invoke-direct {v0, v8}, Lcom/android/settings_ex/applications/ProcessStatsPreference;-><init>(Landroid/content/Context;)V

    .line 758
    .local v65, "pref":Lcom/android/settings_ex/applications/ProcessStatsPreference;
    const/4 v8, 0x0

    move-object/from16 v0, v65

    invoke-virtual {v0, v8, v7}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->init(Landroid/graphics/drawable/Drawable;Lcom/android/settings_ex/applications/ProcStatsEntry;)V

    .line 759
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;

    move-object/from16 v16, v0

    sget-object v18, Lcom/android/settings_ex/applications/ProcessStatsUi;->sEntryCompare:Ljava/util/Comparator;

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z
    ...
    invoke-virtual/range {v14 .. v20}, Lcom/android/settings_ex/applications/ProcStatsEntry;->evaluateTargetPackage(Landroid/content/pm/PackageManager;Lcom/android/internal/app/ProcessStats;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Ljava/util/Comparator;ZZ)V

    .line 761
    invoke-virtual {v7, v15}, Lcom/android/settings_ex/applications/ProcStatsEntry;->retrieveUiData(Landroid/content/pm/PackageManager;)V

    .line 762
    iget-object v8, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mUiLabel:Ljava/lang/String;

    move-object/from16 v0, v65

    invoke-virtual {v0, v8}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 763
    iget-object v8, v7, Lcom/android/settings_ex/applications/ProcStatsEntry;->mUiTargetApp:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v0, v8}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->setOrder(I)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->setPercent(DD)V
    ...
    .end local v58    # "percentOfTime":D
    .end local v60    # "percentOfWeight":D
    .end local v65    # "pref":Lcom/android/settings_ex/applications/ProcessStatsPreference;
    :cond_25
    return-void
    ...
    .line 759
    .restart local v65    # "pref":Lcom/android/settings_ex/applications/ProcessStatsPreference;
    :cond_2a
    const/16 v20, 0x0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 147
    sget-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sStatsXfer:Lcom/android/internal/app/ProcessStats;

    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mProcessStats:Lcom/android/internal/app/IProcessStats;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUm:Landroid/os/UserManager;
    ...
    .line 155
    iget-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mAppListGroup:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStatusPref:Landroid/preference/Preference;
    ...
    sget-object v1, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurations:[J
    ...
    :goto_0
    iput-wide v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J
    ...
    :goto_1
    iput-boolean v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z
    ...
    :goto_2
    iput v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
    ...
    :goto_3
    iput v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemRegion:I
    ...
    .line 156
    :cond_2
    sget-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurations:[J
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 240
    iget-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDurationMenus:[Landroid/view/MenuItem;

    add-int/lit8 v4, v0, 0x2

    sget-object v5, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurationLabels:[I
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystemMenu:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUssMenu:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeBackgroundMenu:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeForegroundMenu:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeCachedMenu:Landroid/view/MenuItem;

    .line 262
    invoke-virtual {p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->updateMenus()V
...
.method public onDestroy()V
    ...
    .line 191
    iget-object v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;

    sput-object v0, Lcom/android/settings_ex/applications/ProcessStatsUi;->sStatsXfer:Lcom/android/internal/app/ProcessStats;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 331
    sget-object v2, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurations:[J

    add-int/lit8 v3, v0, -0x2

    aget-wide v2, v2, v3

    iput-wide v2, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J

    .line 332
    invoke-direct {p0}, Lcom/android/settings_ex/applications/ProcessStatsUi;->refreshStats()V
    ...
    iput-object v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    .line 316
    :pswitch_2
    iget-boolean v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z
    ...
    :cond_1
    iput-boolean v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z
    ...
    .line 320
    :pswitch_3
    iget-boolean v3, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z
    ...
    :cond_2
    iput-boolean v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z
    ...
    iput v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 197
    instance-of v0, p2, Lcom/android/settings_ex/applications/LinearColorPreference;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTimes:[J
    ...
    iget-object v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemStateWeights:[D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemCachedWeight:D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemFreeWeight:D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemZRamWeight:D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemKernelWeight:D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemNativeWeight:D
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemTotalWeight:D
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTotalTime:J
    ...
    const-class v1, Lcom/android/settings_ex/applications/ProcessStatsMemDetail;
    ...
    .line 215
    :cond_1
    instance-of v0, p2, Lcom/android/settings_ex/applications/ProcessStatsPreference;
    ...
    .line 219
    check-cast v7, Lcom/android/settings_ex/applications/ProcessStatsPreference;

    .line 220
    .local v7, "pgp":Lcom/android/settings_ex/applications/ProcessStatsPreference;
    new-instance v2, Landroid/os/Bundle;
    ...
    invoke-virtual {v7}, Lcom/android/settings_ex/applications/ProcessStatsPreference;->getEntry()Lcom/android/settings_ex/applications/ProcStatsEntry;
    ...
    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMaxWeight:J
    ...
    const-class v1, Lcom/android/settings_ex/applications/ProcessStatsDetail;
...
.method public onRegionTapped(I)V
    ...
    .prologue
    .line 340
    iget v0, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemRegion:I

    if-eq v0, p1, :cond_0

    .line 341
    iput p1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemRegion:I
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-wide v2, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z
    ...
    iget v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
    ...
    iget v1, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mMemRegion:I
...
.method updateMenus()V
    ...
    sget-object v6, Lcom/android/settings_ex/applications/ProcessStatsUi;->sDurations:[J

    const/4 v7, 0x0

    aget-wide v6, v6, v7

    iget-wide v8, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J
    ...
    .line 284
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDurationMenus:[Landroid/view/MenuItem;
    ...
    iput-wide v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mDuration:J

    .line 289
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystemMenu:Landroid/view/MenuItem;
    ...
    iget-boolean v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystem:Z

    invoke-interface {v6, v7}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    .line 291
    iget-object v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mShowSystemMenu:Landroid/view/MenuItem;

    iget v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mStatsType:I
    ...
    .line 293
    :cond_5
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUssMenu:Landroid/view/MenuItem;
    ...
    iget-boolean v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mUseUss:Z

    invoke-interface {v6, v7}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    .line 296
    :cond_6
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeBackgroundMenu:Landroid/view/MenuItem;

    if-eqz v6, :cond_7

    .line 297
    iget-object v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeBackgroundMenu:Landroid/view/MenuItem;
    ...
    .line 299
    :cond_7
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeForegroundMenu:Landroid/view/MenuItem;

    if-eqz v6, :cond_8

    .line 300
    iget-object v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeForegroundMenu:Landroid/view/MenuItem;
    ...
    .line 302
    :cond_8
    iget-object v6, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeCachedMenu:Landroid/view/MenuItem;

    if-eqz v6, :cond_9

    .line 303
    iget-object v7, p0, Lcom/android/settings_ex/applications/ProcessStatsUi;->mTypeCachedMenu:Landroid/view/MenuItem;
