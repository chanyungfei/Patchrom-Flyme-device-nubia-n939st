...
.method private updateAgents()V
    ...
    iget-object v6, p0, Lcom/android/settings_ex/TrustAgentSettings;->mAvailableAgents:Landroid/util/ArrayMap;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/TrustAgentSettings;->mAvailableAgents:Landroid/util/ArrayMap;

    .line 79
    :cond_0
    iget-object v6, p0, Lcom/android/settings_ex/TrustAgentSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/TrustAgentSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v5, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->preference:Landroid/preference/SwitchPreference;

    .line 91
    invoke-virtual {v5, v8}, Landroid/preference/SwitchPreference;->setPersistent(Z)V

    .line 92
    iget-object v6, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->label:Ljava/lang/CharSequence;

    invoke-virtual {v5, v6}, Landroid/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 93
    iget-object v6, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->icon:Landroid/graphics/drawable/Drawable;
    ...
    .line 96
    iget-object v6, p0, Lcom/android/settings_ex/TrustAgentSettings;->mActiveAgents:Landroid/util/ArraySet;

    iget-object v7, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->component:Landroid/content/ComponentName;
    ...
    .line 97
    iget-object v6, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->preference:Landroid/preference/SwitchPreference;
