...
.method static synthetic access$300(Lcom/android/settings_ex/location/LocationMode;)Lcom/android/location/XT/IXTSrv;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/location/LocationMode;
...
.method static synthetic access$302(Lcom/android/settings_ex/location/LocationMode;Lcom/android/location/XT/IXTSrv;)Lcom/android/location/XT/IXTSrv;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/location/LocationMode;
...
.method static synthetic access$400(Lcom/android/settings_ex/location/LocationMode;)Lcom/android/location/XT/IXTSrvCb;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/location/LocationMode;
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/location/LocationMode;->addPreferencesFromResource(I)V
    ...
    check-cast v5, Lcom/android/settings_ex/location/RadioButtonPreference;

    iput-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mHighAccuracy:Lcom/android/settings_ex/location/RadioButtonPreference;
    ...
    iput-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mBatterySaving:Lcom/android/settings_ex/location/RadioButtonPreference;
    ...
    iput-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mSensorsOnly:Lcom/android/settings_ex/location/RadioButtonPreference;

    .line 198
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mHighAccuracy:Lcom/android/settings_ex/location/RadioButtonPreference;

    invoke-virtual {v5, p0}, Lcom/android/settings_ex/location/RadioButtonPreference;->setOnClickListener(Lcom/android/settings_ex/location/RadioButtonPreference$OnClickListener;)V

    .line 199
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mBatterySaving:Lcom/android/settings_ex/location/RadioButtonPreference;

    invoke-virtual {v5, p0}, Lcom/android/settings_ex/location/RadioButtonPreference;->setOnClickListener(Lcom/android/settings_ex/location/RadioButtonPreference$OnClickListener;)V

    .line 200
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mSensorsOnly:Lcom/android/settings_ex/location/RadioButtonPreference;
    ...
    check-cast v5, Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;

    iput-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mIZat:Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;

    .line 205
    iget-boolean v5, p0, Lcom/android/settings_ex/location/LocationMode;->izatConnResult:Z
    ...
    :cond_1
    :goto_0
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mIZat:Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;
    ...
    new-instance v6, Lcom/android/settings_ex/location/LocationMode$3;

    invoke-direct {v6, p0}, Lcom/android/settings_ex/location/LocationMode$3;-><init>(Lcom/android/settings_ex/location/LocationMode;)V

    invoke-virtual {v5, v6}, Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-virtual {v5, v2}, Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 215
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationMode;->mIZat:Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;

    iget-object v6, p0, Lcom/android/settings_ex/location/LocationMode;->mXTService:Lcom/android/location/XT/IXTSrv;

    invoke-interface {v6}, Lcom/android/location/XT/IXTSrv;->getStatus()Z

    move-result v6

    invoke-virtual {v5, v6}, Lcom/android/settings_ex/location/WrappingIZatSwitchPreference;->setChecked(Z)V
    :try_end_0
