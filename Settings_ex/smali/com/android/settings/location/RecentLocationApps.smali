...
.method private createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/settings_ex/location/DimmableIconPreference;
    .locals 2
    ...
    .prologue
    .line 88
    new-instance v0, Lcom/android/settings_ex/location/DimmableIconPreference;
    ...
    invoke-direct {v0, v1, p4}, Lcom/android/settings_ex/location/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 89
    .local v0, "pref":Lcom/android/settings_ex/location/DimmableIconPreference;
    invoke-virtual {v0, p1}, Lcom/android/settings_ex/location/DimmableIconPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 90
    invoke-virtual {v0, p2}, Lcom/android/settings_ex/location/DimmableIconPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/location/DimmableIconPreference;->setSummary(I)V

    .line 96
    :goto_0
    invoke-virtual {v0, p5}, Lcom/android/settings_ex/location/DimmableIconPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
    ...
    .line 183
    .local v19, "preference":Lcom/android/settings_ex/location/DimmableIconPreference;
    :try_start_0
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/settings_ex/location/RecentLocationApps;->createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/settings_ex/location/DimmableIconPreference;
    :try_end_0
