.class public Lcom/android/settings_ex/MultiSimSettingTab;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/MultiSimSettingTab;->backBtn:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/MultiSimSettingTab;->tabIcons:[I
    ...
    iput-object v0, p0, Lcom/android/settings_ex/MultiSimSettingTab;->tabSpecTags:[Ljava/lang/String;
...
.method public static getMultiSimName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .prologue
    .line 141
    invoke-static {p0, p1}, Lcom/android/settings_ex/MultiSimSettingTab;->findRecordBySlotId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 191
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/settings_ex/MultiSimSettingTab;->finish()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v10}, Lcom/android/settings_ex/MultiSimSettingTab;->logd(Ljava/lang/String;)V

    .line 89
    invoke-virtual {p0}, Lcom/android/settings_ex/MultiSimSettingTab;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v10}, Lcom/android/settings_ex/MultiSimSettingTab;->getString(I)Ljava/lang/String;

    move-result-object v9

    .end local v9    # "title":Ljava/lang/String;
    :cond_0
    invoke-virtual {p0, v9}, Lcom/android/settings_ex/MultiSimSettingTab;->setTitle(Ljava/lang/CharSequence;)V

    .line 93
    const/4 v10, 0x1

    invoke-virtual {p0, v10}, Lcom/android/settings_ex/MultiSimSettingTab;->requestWindowFeature(I)Z

    .line 95
    const v10, 0x7f040083

    invoke-virtual {p0, v10}, Lcom/android/settings_ex/MultiSimSettingTab;->setContentView(I)V

    .line 97
    const v10, 0x7f0f0134

    invoke-virtual {p0, v10}, Lcom/android/settings_ex/MultiSimSettingTab;->findViewById(I)Landroid/view/View;

    move-result-object v10

    check-cast v10, Landroid/widget/ImageView;

    iput-object v10, p0, Lcom/android/settings_ex/MultiSimSettingTab;->backBtn:Landroid/widget/ImageView;

    .line 98
    iget-object v10, p0, Lcom/android/settings_ex/MultiSimSettingTab;->backBtn:Landroid/widget/ImageView;

    invoke-virtual {v10, p0}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 101
    invoke-virtual {p0}, Lcom/android/settings_ex/MultiSimSettingTab;->getResources()Landroid/content/res/Resources;

    move-result-object v6

    .line 103
    .local v6, "res":Landroid/content/res/Resources;
    invoke-virtual {p0}, Lcom/android/settings_ex/MultiSimSettingTab;->getTabHost()Landroid/widget/TabHost;
    ...
    iget-object v10, p0, Lcom/android/settings_ex/MultiSimSettingTab;->tabSpecTags:[Ljava/lang/String;
    ...
    invoke-static {p0, v2}, Lcom/android/settings_ex/MultiSimSettingTab;->getMultiSimName(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v11

    iget-object v12, p0, Lcom/android/settings_ex/MultiSimSettingTab;->tabIcons:[I
