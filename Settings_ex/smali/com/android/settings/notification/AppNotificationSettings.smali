...
.method static synthetic access$000(Lcom/android/settings_ex/notification/AppNotificationSettings;)Lcom/android/settings_ex/notification/NotificationAppList$AppRow;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/notification/AppNotificationSettings;

    .prologue
    .line 47
    iget-object v0, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/settings_ex/notification/AppNotificationSettings;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/notification/AppNotificationSettings;
...
.method static synthetic access$200(Lcom/android/settings_ex/notification/AppNotificationSettings;)Lcom/android/settings_ex/notification/NotificationAppList$Backend;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/notification/AppNotificationSettings;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-boolean v8, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mCreated:Z
    ...
    .line 71
    :cond_0
    iget-boolean v6, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mCreated:Z
    ...
    .line 75
    :cond_2
    iput-boolean v10, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mCreated:Z

    .line 76
    iget-object v6, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;
    ...
    iget-object v6, v6, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, v6, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->label:Ljava/lang/CharSequence;
    ...
    iget-object v6, v6, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->settingsIntent:Landroid/content/Intent;
    ...
    .line 93
    new-instance v6, Lcom/android/settings_ex/notification/AppNotificationSettings$1;

    invoke-direct {v6, p0}, Lcom/android/settings_ex/notification/AppNotificationSettings$1;-><init>(Lcom/android/settings_ex/notification/AppNotificationSettings;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mContext:Landroid/content/Context;
    ...
    sget-boolean v9, Lcom/android/settings_ex/notification/AppNotificationSettings;->DEBUG:Z
    ...
    invoke-static {v5, v4, v8}, Lcom/android/settings_ex/notification/AppNotificationSettings;->findPackageInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings_ex/notification/AppNotificationSettings;->addPreferencesFromResource(I)V

    .line 135
    const-string v9, "block"

    invoke-virtual {p0, v9}, Lcom/android/settings_ex/notification/AppNotificationSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v9

    check-cast v9, Landroid/preference/SwitchPreference;

    iput-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iget-object v10, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mBackend:Lcom/android/settings_ex/notification/NotificationAppList$Backend;

    invoke-static {v5, v9, v10}, Lcom/android/settings_ex/notification/NotificationAppList;->loadAppRow(Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;Lcom/android/settings_ex/notification/NotificationAppList$Backend;)Lcom/android/settings_ex/notification/NotificationAppList$AppRow;

    move-result-object v9

    iput-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;
    ...
    iput-object v9, v10, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->settingsIntent:Landroid/content/Intent;

    .line 159
    :cond_9
    :goto_1
    iget-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;

    iget-object v10, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;

    iget-boolean v10, v10, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->banned:Z

    invoke-virtual {v9, v10}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 160
    iget-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;

    iget-object v10, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;

    iget-boolean v10, v10, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->priority:Z

    invoke-virtual {v9, v10}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 161
    iget-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iget-boolean v10, v10, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->sensitive:Z
    ...
    invoke-direct {v10, p0, v4, v8}, Lcom/android/settings_ex/notification/AppNotificationSettings$2;-><init>(Lcom/android/settings_ex/notification/AppNotificationSettings;Ljava/lang/String;I)V
    ...
    invoke-direct {v10, p0, v4, v8}, Lcom/android/settings_ex/notification/AppNotificationSettings$3;-><init>(Lcom/android/settings_ex/notification/AppNotificationSettings;Ljava/lang/String;I)V
    ...
    invoke-direct {v10, p0, v4, v8}, Lcom/android/settings_ex/notification/AppNotificationSettings$4;-><init>(Lcom/android/settings_ex/notification/AppNotificationSettings;Ljava/lang/String;I)V

    invoke-virtual {v9, v10}, Landroid/preference/SwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 192
    :cond_b
    invoke-static {v5, v2}, Lcom/android/settings_ex/Utils;->isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    .line 155
    .local v6, "rows":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/notification/NotificationAppList$AppRow;>;"
    iget-object v9, p0, Lcom/android/settings_ex/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings_ex/notification/NotificationAppList$AppRow;

    iget-object v9, v9, Lcom/android/settings_ex/notification/NotificationAppList$AppRow;->pkg:Ljava/lang/String;
    ...
    invoke-static {v9, v6}, Lcom/android/settings_ex/notification/NotificationAppList;->collectConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;)V
