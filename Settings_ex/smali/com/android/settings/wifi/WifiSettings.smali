...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mAutoConnect:Z
...
.method private getOtherAvaiConfigNetwork(Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, v2}, Lcom/android/settings_ex/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 1107
    invoke-virtual {v0, p3, p4}, Lcom/android/settings_ex/wifi/AccessPoint;->update(Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 1114
    .local v5, "ignoreAccessPoint":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/settings_ex/wifi/AccessPoint;>;"
    if-eqz v1, :cond_5
    ...
    .line 1116
    .local v6, "point":Lcom/android/settings_ex/wifi/AccessPoint;
    ...
    .line 1121
    :cond_4
    invoke-virtual {v6}, Lcom/android/settings_ex/wifi/AccessPoint;->getLevel()I
    ...
    .line 1126
    .end local v4    # "i$":Ljava/util/Iterator;
    .end local v6    # "point":Lcom/android/settings_ex/wifi/AccessPoint;
    :cond_5
...
.method private handleEvent(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/settings_ex/wifi/WifiSettings;->updateWifiState(I)V
    ...
    iget-object v2, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mConnected:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {p0, v2}, Lcom/android/settings_ex/wifi/WifiSettings;->changeNextButtonState(Z)V
    ...
    invoke-direct {p0, v2}, Lcom/android/settings_ex/wifi/WifiSettings;->updateNetworkInfo(Landroid/net/NetworkInfo;)V
...
.method private reconnect()V
    ...
    invoke-direct {p0, v4, v5, v6, v7}, Lcom/android/settings_ex/wifi/WifiSettings;->getOtherAvaiConfigNetwork(Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Ljava/util/List;

    move-result-object v1

    .line 1077
    .local v1, "availableNetworks":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/wifi/AccessPoint;>;"
    const/4 v2, 0x0
    ...
    check-cast v4, Lcom/android/settings_ex/wifi/AccessPoint;
    ...
    iget v5, v0, Lcom/android/settings_ex/wifi/AccessPoint;->networkId:I

    iget-object v6, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mConnectListener:Landroid/net/wifi/WifiManager$ActionListener;
...
.method private updateWifiState(I)V
    ...
    .line 879
    iput-object v4, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mLastNetworkInfo:Landroid/net/NetworkInfo;
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 584
    iget-boolean v1, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mAutoConnect:Z

    if-eqz v1, :cond_0

    .line 585
    invoke-direct {p0}, Lcom/android/settings_ex/wifi/WifiSettings;->reconnect()V
...
.method public onResume()V
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mAutoConnect:Z
