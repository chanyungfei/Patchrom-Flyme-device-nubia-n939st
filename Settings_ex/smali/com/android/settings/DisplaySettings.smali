...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/DisplaySettings$Receiver;
    }
.end annotation
...
.field mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;
...
.field private final mReceiver:Lcom/android/settings_ex/DisplaySettings$Receiver;
...
.field private mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/DisplaySettings;->ACTION_BRIGHTNESS_MODE_CHANGED:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 107
    new-instance v0, Lcom/android/settings_ex/DisplaySettings$Receiver;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/DisplaySettings$Receiver;-><init>(Lcom/android/settings_ex/DisplaySettings;Lcom/android/settings_ex/DisplaySettings$1;)V

    iput-object v0, p0, Lcom/android/settings_ex/DisplaySettings;->mReceiver:Lcom/android/settings_ex/DisplaySettings$Receiver;
...
.method static synthetic access$100()Ljava/lang/String;
    ...
    .prologue
    .line 66
    sget-object v0, Lcom/android/settings_ex/DisplaySettings;->ACTION_BRIGHTNESS_MODE_CHANGED:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/settings_ex/DisplaySettings;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$300(Lcom/android/settings_ex/DisplaySettings;)Landroid/preference/SwitchPreference;
    ...
    .prologue
    .line 66
    iget-object v0, p0, Lcom/android/settings_ex/DisplaySettings;->mAutoBrightnessPreference:Landroid/preference/SwitchPreference;
...
.method private updateCablBrightnessCheckbox()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/settings_ex/DisplaySettings;->mCablBrightnessPreference:Landroid/preference/CheckBoxPreference;
...
.method private updateState()V
    ...
    .line 402
    iget-object v2, p0, Lcom/android/settings_ex/DisplaySettings;->mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;

    invoke-virtual {v2}, Lcom/android/settings_ex/CABLServiceWrapper;->isCABLAvailable()Z
    ...
    .line 403
    invoke-direct {p0}, Lcom/android/settings_ex/DisplaySettings;->updateCablBrightnessCheckbox()V
...
.method private updateTimeoutPreferenceDescription(J)V
    ...
    .line 282
    iget-object v3, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mContext:Landroid/content/Context;

    .line 120
    const v7, 0x7f060024

    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DisplaySettings;->addPreferencesFromResource(I)V

    .line 122
    const-string v7, "my_brightness_auto"

    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mYSeekbar:Landroid/preference/Preference;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenSaverPreference:Landroid/preference/Preference;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenSaverPreference:Landroid/preference/Preference;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenColorPreference:Landroid/preference/Preference;

    .line 132
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenColorPreference:Landroid/preference/Preference;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenColorPreference:Landroid/preference/Preference;
    ...
    check-cast v7, Lcom/android/settings_ex/ScreenTimeoutPreference;

    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;
    ...
    :goto_1
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;

    invoke-static {v8, v9}, Ljava/lang/String;->valueOf(J)Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v7, v12}, Lcom/android/settings_ex/ScreenTimeoutPreference;->setValue(Ljava/lang/String;)V

    .line 151
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;

    invoke-virtual {v7, p0}, Lcom/android/settings_ex/ScreenTimeoutPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 152
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mScreenTimeoutPreference:Lcom/android/settings_ex/ScreenTimeoutPreference;

    invoke-direct {p0, v7}, Lcom/android/settings_ex/DisplaySettings;->disableUnusableTimeouts(Landroid/preference/ListPreference;)V
    ...
    check-cast v7, Lcom/android/settings_ex/WarnedListPreference;

    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mFontSizePref:Lcom/android/settings_ex/WarnedListPreference;

    .line 156
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mFontSizePref:Lcom/android/settings_ex/WarnedListPreference;

    invoke-virtual {v7, p0}, Lcom/android/settings_ex/WarnedListPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 157
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mFontSizePref:Lcom/android/settings_ex/WarnedListPreference;

    invoke-virtual {v7, p0}, Lcom/android/settings_ex/WarnedListPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    invoke-static {v7}, Lcom/android/settings_ex/DisplaySettings;->isAutomaticBrightnessAvailable(Landroid/content/res/Resources;)Z
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mAutoBrightnessPreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/DisplaySettings;->mYSeekbar:Landroid/preference/Preference;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mCablBrightnessPreference:Landroid/preference/CheckBoxPreference;

    .line 173
    new-instance v7, Lcom/android/settings_ex/CABLServiceWrapper;

    invoke-virtual {p0}, Lcom/android/settings_ex/DisplaySettings;->getActivity()Landroid/app/Activity;

    move-result-object v12

    invoke-direct {v7, v12}, Lcom/android/settings_ex/CABLServiceWrapper;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;

    .line 174
    iget-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;

    invoke-virtual {v7}, Lcom/android/settings_ex/CABLServiceWrapper;->isCABLAvailable()Z
    ...
    iget-object v12, p0, Lcom/android/settings_ex/DisplaySettings;->mCablBrightnessPreference:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mLiftToWakePreference:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DisplaySettings;->mDozePreference:Landroid/preference/SwitchPreference;
    ...
    .line 197
    .local v6, "rotatePreference":Lcom/android/settings_ex/notification/DropDownPreference;
    const v7, 0x7f090aff
    ...
    invoke-virtual {v6, v7, v12}, Lcom/android/settings_ex/notification/DropDownPreference;->addItem(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_8
    invoke-virtual {v6, v7}, Lcom/android/settings_ex/notification/DropDownPreference;->setSelectedItem(I)V

    .line 218
    new-instance v7, Lcom/android/settings_ex/DisplaySettings$1;

    invoke-direct {v7, p0, v0}, Lcom/android/settings_ex/DisplaySettings$1;-><init>(Lcom/android/settings_ex/DisplaySettings;Landroid/app/Activity;)V

    invoke-virtual {v6, v7}, Lcom/android/settings_ex/notification/DropDownPreference;->setCallback(Lcom/android/settings_ex/notification/DropDownPreference$Callback;)V

    .line 228
    .end local v5    # "rotateLockedResourceId":I
    .end local v6    # "rotatePreference":Lcom/android/settings_ex/notification/DropDownPreference;
    :goto_9
    return-void
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DisplaySettings;->removePreference(Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Lcom/android/settings_ex/CABLServiceWrapper;->initCABLService()V
    ...
    .line 206
    .restart local v6    # "rotatePreference":Lcom/android/settings_ex/notification/DropDownPreference;
    :cond_9
...
.method public onDestroy()V
    ...
    .prologue
    .line 560
    iget-object v0, p0, Lcom/android/settings_ex/DisplaySettings;->mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;

    invoke-virtual {v0}, Lcom/android/settings_ex/CABLServiceWrapper;->isCABLAvailable()Z
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/CABLServiceWrapper;->onDestory()V

    .line 563
    :cond_0
    iget-object v0, p0, Lcom/android/settings_ex/DisplaySettings;->mReceiver:Lcom/android/settings_ex/DisplaySettings$Receiver;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/DisplaySettings$Receiver;->register(Z)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v9, p0, Lcom/android/settings_ex/DisplaySettings;->mYSeekbar:Landroid/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 447
    iget-object v1, p0, Lcom/android/settings_ex/DisplaySettings;->mCABLServiceWrapper:Lcom/android/settings_ex/CABLServiceWrapper;

    invoke-virtual {v1}, Lcom/android/settings_ex/CABLServiceWrapper;->startCABL()V
    ...
    invoke-virtual {v1}, Lcom/android/settings_ex/CABLServiceWrapper;->stopCABL()V
